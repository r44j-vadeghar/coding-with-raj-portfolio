...
export type Project = {
  ...
  demoLink: string;
  bgImg: string;
  projectPagesDetails: ProjectPageDetails[];
};
...
export const colleges: College[] = [
  {
    ...
    reviews: [
      ...
      "One thing to note about the college is that they don't provide placement services, so it's important to be proactive in seeking out job opportunities on your own."
    ],
    img: "/img/ku-clg.png"
  },

  {
    ...
    desc: "Passed with distinction. I've studied software engineering, web security, and operating systems.",
    reviews: [
      "The community at this College is welcoming and supportive.",
      "This College offers excellent opportunities for research and internships."
    ],
